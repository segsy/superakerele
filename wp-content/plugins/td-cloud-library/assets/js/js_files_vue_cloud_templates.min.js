...
a.templatesReady=!0},error:function(b,a,d){console.log("%c"+d,"color: #dc2121c7")}})},getTplCardHeader:function(a,b){if(a.startsWith("pa_"))return"Woo attribute - "+b.tpl_card_data_assets.att_data.attribute_label;if("woo_archive"===a)return"Woo categories archive templates";a=a.replaceAll("_"," ");return a.charAt(0).toUpperCase()+a.slice(1)+" templates"},cloudLibraryImport:function(a){a=a.startsWith("pa_")||"woo_archive_tag"===a||"woo_archive_attribute"===a?"woo_archive":a;window.tdbVue.router.push({name:"loadRoute",
params:{wp_type:a,force_parent_template_type:a,hide_mobile_selector:"hide",install_template_route:"addRoute"}})},isShopTpl:function(a){switch(a){case "woo_product":case "woo_archive":case "woo_archive_tag":case "woo_archive_attribute":case "woo_search_archive":case "woo_shop_base":return!0}return a.startsWith("pa_")}},watch:{},components:{"templates-card":window.tdbCloudTemplatesVue.templates_card}};
