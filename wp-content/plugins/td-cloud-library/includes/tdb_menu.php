                ...
                if( $item->menu_item_parent == 0 ) {
                    if( $main_sub_menu_icon != '' ) {
                        if( array_key_exists( $main_sub_menu_icon, $svg_list ) ) {
                            $item_output .= '<span class="tdb-sub-menu-icon tdb-sub-menu-icon-svg tdb-main-sub-menu-icon">' . base64_decode($svg_list[$main_sub_menu_icon]) . '</span>';
                        } else {
                    ...
                    if( $sub_menu_icon != '' ) {
                        if( array_key_exists( $sub_menu_icon, $svg_list ) ) {
                            $item_output .= '<span class="tdb-sub-menu-icon tdb-sub-menu-icon-svg">' . base64_decode($svg_list[$sub_menu_icon]) . '</span>';
                        } else {
