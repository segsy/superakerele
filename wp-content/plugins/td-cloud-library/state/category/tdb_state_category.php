        	...
        	if (self::is_tax()) {
		        ...
		        if ( isset( $atts[ 'prev_tdicon' ] ) ) {
			        ...
			        if ( array_key_exists( $prev_icon, $svg_list ) ) {
				        $prev_icon_html = '<span class="page-nav-icon page-nav-icon-svg">' . base64_decode( $svg_list[ $prev_icon ] ) . '</span>';
			        } else {
		        ...
		        if ( isset( $atts[ 'next_tdicon' ] ) ) {
			        ...
			        if ( array_key_exists( $next_icon, $svg_list ) ) {
				        $next_icon_html = '<span class="page-nav-icon page-nav-icon-svg">' . base64_decode( $svg_list[ $next_icon ] ) . '</span>';
			        } else {
