    ...
    function inner( $menu, $menu_type = '' ) {
        ...
        if( $main_sub_icon != '' ) {
            $buffy .= '<div class="tdb-main-sub-icon-fake">';
                if( base64_encode( base64_decode( $main_sub_icon ) ) == $main_sub_icon ) {
                    $main_sub_icon_html = '<span class="tdb-menu-more-subicon tdb-menu-more-subicon-svg tdb-main-sub-menu-icon">' . base64_decode( $main_sub_icon ) . '</span>';
                    $buffy .= '<span class="tdb-sub-menu-icon tdb-sub-menu-icon-svg">' . base64_decode( $main_sub_icon ) . '</span>';
                } else {
        ...
        if( $sub_icon != '' ) {
            $buffy .= '<div class="tdb-sub-icon-fake">';
                if( base64_encode( base64_decode( $sub_icon ) ) == $sub_icon ) {
                    $buffy .= '<span class="tdb-sub-menu-icon tdb-sub-menu-icon-svg">' . base64_decode( $sub_icon ) . '</span>';
                } else {
        ...
        if( $sep_icon != '' ) {
            if( base64_encode( base64_decode( $sep_icon ) ) == $sep_icon ) {
                $sep_icon_html = '<span class="tdb-menu-sep tdb-menu-sep-svg">' . base64_decode( $sep_icon ) . '</span>';
            } else {
        ...
        if( $more_icon != '' ) {
            if( base64_encode( base64_decode( $more_icon ) ) == $more_icon ) {
                $more_icon_html = '<span class="tdb-menu-more-icon tdb-menu-more-icon-svg">' . base64_decode( $more_icon ) . '</span>';
            } else {
