        ...
        $buffy .= '<div class="' . $this->get_block_classes() . ' tdb-header-align" ' . $this->get_block_html_atts() . '>';
            ...
            if( $login_icon != '' ) {
                if( base64_encode( base64_decode( $login_icon ) ) == $login_icon ) {
                    $login_icon_html = '<span class="tdb-head-usr-log-icon tdb-head-usr-log-icon-svg">' . base64_decode( $login_icon ) . '</span>';
                } else {
            ...
            if( $logout_icon != '' ) {
                if( base64_encode( base64_decode( $logout_icon ) ) == $logout_icon ) {
                    $logout_icon_html = '<span class="tdb-head-usr-log-icon tdb-head-usr-log-icon-svg">' . base64_decode( $logout_icon ) . '</span>';
                } else {
