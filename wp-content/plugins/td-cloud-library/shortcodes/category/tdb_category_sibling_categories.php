    ...
    function render( $atts, $content = null ) {
        ...
        if( $tdicon != '' ) {
            if( base64_encode( base64_decode( $tdicon ) ) == $tdicon ) {
                $tdicon_html = '<span class="tdb-cat-sep tdb-cat-sep-svg">' . base64_decode( $tdicon ) . '</span>';
            } else {
        ...
        if( $btn_icon != '' ) {
            if( base64_encode( base64_decode( $btn_icon ) ) == $btn_icon ) {
                $btn_icon_html = '<span class="td-subcat-more-icon td-subcat-more-icon-svg">' . base64_decode( $btn_icon ) . '</span>';
            } else {
