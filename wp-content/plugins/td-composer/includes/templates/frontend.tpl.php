						...
						if ( isset( $mapped_shortcode['tdc_category'] ) ) {
							switch( $mapped_shortcode['tdc_category'] ) {
                                ...
                                case 'Category page':
                                    ...
                                    if ('tdb_category_bg_image' !== $mapped_shortcode['base'] ) {
					...
					if ( ! empty( $external_mapped_shortcodes ) ) {
						...
						if ( 'page' === $tdbTemplateType ) {
                            foreach ( $common_page_el_mapped_shortcodes as $common_page_el_mapped_shortcode ) {
                                if ( $common_page_el_mapped_shortcode['base'] === 'tdb_loop' || $common_page_el_mapped_shortcode['base'] === 'tdb_loop_2' || $common_page_el_mapped_shortcode['base'] === 'tdb_breadcrumbs' || $common_page_el_mapped_shortcode['base'] === 'tdb_title' || $common_page_el_mapped_shortcode['base'] === 'tdb_woo_menu_cart' || $common_page_el_mapped_shortcode['base'] === 'tdb_single_post_share' ) {
