...
//	if ( ( 'Newspaper' == TD_THEME_NAME && version_compare($td_db_version, '10', '<') ) || ( 'Newsmag' == TD_THEME_NAME && version_compare($td_db_version, '4.9.2', '<') ) || TD_DEPLOY_MODE == 'dev' ) {
        ...
        if ($social_drag_and_drop != '' && array_key_exists('flipboard', $social_drag_and_drop) === false) {
            $social_drag_and_drop['flipboard'] = '';
        }
        if ($social_drag_and_drop != '' && array_key_exists('copy_url', $social_drag_and_drop) === false) {
            $social_drag_and_drop['copy_url'] = '';
        }
