...
if ( defined('TD_COMPOSER' ) ) {
    ...
    if ( strpos( td_util::get_registration(), chr(42 ) ) > 0 || TD_DEPLOY_MODE == 'dev' ) {
        ...
        <span id="tdb-update-system" style="<?php echo $td_checked_licence ? '' : 'display: none'?>">
                            ...
                            jQuery().ready(function() {
                                ...
                                jQuery('body').on( 'click', '.td-panel-update-theme', function (event) {
                                    ...
                                    tdConfirm.modal({
                                        ...
                                        htmlInfoContent: 'VERY IMPORTANT! Before you update to ' + $selected_update.text() + ' version, please take a full website and database backup. This step ensures that you can easily revert to your previous version if something unexpected happens during the update. <a target="_blank" href="https://forum.tagdiv.com/how-to-update-the-theme-2/">Read more</a><br><br><br>Continue to update?',
                                        switchButtons: false,
                                        textYes: 'Update',
                                    ...
                                    tdConfirm.modal({
                                        ...
                                        url: '#TB_inline?inlineId=td-confirm&width=780',
                                        htmlInfoContent: 'VERY IMPORTANT! Before you update to <?php echo TD_THEME_NAME ?> ' + dataVersion + ' version, please take a full website and database backup. This step ensures that you can easily revert to your previous version if something unexpected happens during the update. <a target="_blank" href="https://forum.tagdiv.com/how-to-update-the-theme-2/">Read more</a><br><br><br>Continue to update?',
                                        switchButtons: false,
                                        textYes: 'Update',
                                        callbackYes: function() {
