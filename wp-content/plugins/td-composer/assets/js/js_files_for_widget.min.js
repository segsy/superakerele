...
b){a=k(b).find(".tdc-element");a.length?a.addClass("tdc-element-inner-column").wrapAll('<div class="tdc-elements"></div>'):(b=k(b).find(".wpb_wrapper"),b.length&&b.append('<div class="tdc-elements"></div>'))})});a.find(".tdc-element, .tdc-element-inner-row").each(function(a,b){a=k(b);a.length&&a.not(".tdc-element-inner-column").addClass("tdc-element-column")});b=a.find(".tdc-element, .tdc-element-inner-row");b.length?b.not(".tdc-element-inner-column").wrapAll('<div class="tdc-elements"></div>'):(b=
a.find(".wpb_wrapper"),b.length&&b.append('<div class="tdc-elements"></div>'));a.find(".tdc-elements:empty").each(function(a,b){a="";b=k(b);b.closest(".tdc-inner-column").length?a=" tdc-element-inner-column":b.closest(".tdc-column").length&&(a=" tdc-element-column");a=k('<div class="'+tdcOperationUI._emptyElementClass+a+'"></div>');tdcElementUI.bindEmptyElement(a);b.append(a)})};window.addInnerRowWrappers=function(a){var b=a.find(".td_block_wrap");window.checkTdBlockWrap(b);b.addClass("tdc-element");
a.find(".tdc-inner-row").each(function(a,b){k(b).find(".tdc-inner-column").wrapAll('<div class="tdc-inner-columns"></div>').each(function(a,b){a=k(b).find(".tdc-element");a.length?a.addClass("tdc-element-inner-column").wrapAll('<div class="tdc-elements"></div>'):(b=k(b).find(".wpb_wrapper"),b.length&&b.append('<div class="tdc-elements"></div>'))})});a.find(".tdc-elements:empty").each(function(a,b){a="";b=k(b);b.closest(".tdc-inner-column").length?a=" tdc-element-inner-column":b.closest(".tdc-column").length&&
(a=" tdc-element-column");a=k('<div class="'+tdcOperationUI._emptyElementClass+a+'"></div>');tdcElementUI.bindEmptyElement(a);b.append(a)})};window.addInnerColumnWrappers=function(a){var b=a.find(".td_block_wrap");window.checkTdBlockWrap(b);b.addClass("tdc-element");b=a.find(".tdc-element");b.length?b.addClass("tdc-element-inner-column").wrapAll('<div class="tdc-elements"></div>'):(b=a.find(".wpb_wrapper"),b.length&&b.append('<div class="tdc-elements"></div>'));a.find(".tdc-elements:empty").each(function(a,
b){a="";b=k(b);b.closest(".tdc-inner-column").length?a=" tdc-element-inner-column":b.closest(".tdc-column").length&&(a=" tdc-element-column");a=k('<div class="'+tdcOperationUI._emptyElementClass+a+'"></div>');tdcElementUI.bindEmptyElement(a);b.append(a)})};window.addLoopWrappers=function(a){a.find(".td-main-content").wrap('<div class="tdc-loop-content"></div>')};window.addSidebarWrappers=function(a){a.find(".td-main-sidebar").wrap('<div class="tdc-sidebar-content"></div>')};window.checkTdBlockWrap=
function(a){a.each(function(a,b){a=k(b);a.hasClass("tdc-block-empty")&&a.removeClass("tdc-block-empty");0===parseInt(a.height())&&a.addClass("tdc-block-empty")})};tdcAdminIFrameUI.checkIframe(tdcAdminIFrameUI._$liveIframe)},loadIframe:function(){(tdDetect.isIe8||tdDetect.isIe9||tdDetect.isIe10)&&tdConfirm.showModalOk("Browser Information","TagDiv Composer does not work with Internet Explorer 8, 9, 10",function(){tb_remove()});var a=k(this).contents();"header"!==window.tdcPostSettings.tdbTemplateType&&
"footer"!==window.tdcPostSettings.tdbTemplateType||a.find(".tdc-content-wrap").html("");tdcAdminIFrameUI.initContent(a);tdcAdminIFrameUI._liveIframeWindowObject=k(this).get(0).contentWindow;var c=k('<div id="tdc-recycle" class="tdc-recycle"><div class="tdc-delete-text"><span>Delete</span></div></div>');a.find("body").prepend(c);tdcAdminWrapperUI.$recycle=c;tdcIFrameData._postOriginalContentJSON=b;window.addWrappers(a,".td-main-content-wrap","tdc_content");window.addWrappers(a,".td-header-desktop-wrap",
...
tdcWindowFrame.$_window.height()&&(c=tdcAdminIFrameUI.getIframeWindow().scrollY+tdcWindowFrame.$_window.height()-d);e=tdcAdminIFrameUI.getLiveIframe();e=(e.parent().width()-e.width())/2;k(a.target).trigger(k.Event("contextmousedown",{pageX:b+e,pageY:c}))}})},checkIframe:function(a){if(c.isUndefined(a)){a=window.tdcPostSettings.postUrl;var e="";!1!==window.tdcPostSettings.tdbLoadDataFromId&&(e+="&tdbLoadDataFromId="+window.tdcPostSettings.tdbLoadDataFromId);!1!==window.tdcPostSettings.tdbTemplateType&&
(e+="&tdbTemplateType="+window.tdcPostSettings.tdbTemplateType);a=0>a.indexOf("?")?a+("?td_action=tdc_edit&post_id="+window.tdcPostSettings.postId+e):a+("&td_action=tdc_edit&post_id="+window.tdcPostSettings.postId+e);a=k('<iframe id="tdc-live-iframe" name="tdc-live-iframe" src="'+a+'" scrolling="auto" style="width: 100%; height: 100%" class="tdc-responsive-all"></iframe>').on("load",tdcAdminIFrameUI.loadIframe);k("#tdc-live-iframe-wrapper").append(a)}else{var f=a;e=f.contents();tdcAdminIFrameUI.initContent(e);
...
tdcCssEditor._keydownTextInput);a.on("keyup mousewheel",".tdc-tab-design input.tdc-css-width",tdcCssEditor._changeTextInput);a.on("keydown",".tdc-tab-design input.tdc-css-shadow-size",tdcCssEditor._keydownTextInput);a.on("keyup mousewheel",".tdc-tab-design input.tdc-css-shadow-size",tdcCssEditor._changeTextInput);a.on("change keyup",".tdc-tab-design .tdc-css-shadow-color",tdcCssEditor._changeColor);a.on("keydown",".tdc-tab-design input.tdc-css-shadow-offset-h",tdcCssEditor._keydownTextInput);a.on("keyup mousewheel",
".tdc-tab-design input.tdc-css-shadow-offset-h",tdcCssEditor._changeTextInput);a.on("keydown",".tdc-tab-design input.tdc-css-shadow-offset-v",tdcCssEditor._keydownTextInput);a.on("keyup mousewheel",".tdc-tab-design input.tdc-css-shadow-offset-v",tdcCssEditor._changeTextInput);a.on("change",".tdc-tab-design .tdc-css-bg-style",tdcCssEditor._changeDropDown);a.on("change",".tdc-tab-design .tdc-css-bg-position",tdcCssEditor._changeDropDown);a.on("keydown",".tdc-tab-design input.tdc-css-opacity",tdcCssEditor._keydownTextInput);
a.on("keyup mousewheel",".tdc-tab-design input.tdc-css-opacity",tdcCssEditor._changeTextInput);a.on("change keyup",".tdc-tab-design input.tdc-css-color-1-overlay",tdcCssEditor._changeColor);a.on("change keyup",".tdc-tab-design input.tdc-css-color-2-overlay",tdcCssEditor._changeColor);a.on("keydown",".tdc-tab-design input.tdc-css-gradient-direction",tdcCssEditor._keydownTextInput);a.on("keyup mousewheel",".tdc-tab-design input.tdc-css-gradient-direction",tdcCssEditor._changeTextInput);a.on("change",
".tdc-tab-design .tdc-css-content-h-align",tdcCssEditor._changeDropDown);a.on("keydown",".tdc-tab-design input.tdc-css-order",tdcCssEditor._keydownTextInput);a.on("keyup mousewheel",".tdc-tab-design input.tdc-css-order",tdcCssEditor._changeTextInput);a.on("keydown",".tdc-tab-design input.tdc-css-z-index",tdcCssEditor._keydownTextInput);a.on("keyup mousewheel",".tdc-tab-design input.tdc-css-z-index",tdcCssEditor._changeTextInput);a.on("change",".tdc-tab-design .tdc-css-display",tdcCssEditor._changeDropDown);
a.on("mousedown",".tdc-tab-design .wp-picker-clear",tdcCssEditor._clearColorPicker);a.on("click",".tdc-tab-design .tdc-inherit-select",tdcCssEditor._inheritSelect);a.on("click",".tdc-tab-design .tdc-inherit-color",tdcCssEditor._inheritColor);a.on("click",".tdc-tab-design .tdc-css-image-wrap",tdcCssEditor.tdcCssImageWrapHandler);a.on("click",".tdc-tab-design .tdc-css-image-remove",tdcCssEditor.tdcCssImageRemoveHandler);a.on("click",".tdc-tab-design .tdc-inherit-image",tdcCssEditor._inheritImage);a.on("click",
".tdc-clear-css-properties",tdcCssEditor._clearCssProperties)},setMediaInterval:function(b,c){var e=k(".tdc-media-interval");e.length||(e=k('<div class="tdc-media-interval"><div class="tdc-media-interval-head"><label></label> - <output></output></div><input type="range" name="mediaIntervalInput" min="20" max="50" step="1" value="30" data-scroll-bar-width="'+c+'"></div>'),k("body").append(e),e.find("input").on("input",function(b){var c=k(this),d=tdcAdminIFrameUI.getLiveIframe(),f=c.data("scroll-bar-width");
e.find("output").html(c.val());tdcCssEditor.timeoutMediaInterval=setTimeout(function(){a.isUndefined(tdcCssEditor.timeoutMediaInterval)||clearTimeout(tdcCssEditor.timeoutMediaInterval);d.css("width",parseInt(c.val())+parseInt(f))},200)}));""===b?e.hide():(e.show(),tdcCssEditor.timeoutIframeHtml=setTimeout(function(){a.isUndefined(tdcCssEditor.timeoutIframeHtml)||clearTimeout(tdcCssEditor.timeoutIframeHtml);if(!a.isUndefined(tdcSidebar.currentViewportSettings.settings)){var c=e.find("label"),d=e.find("input"),
l=e.find("output");c.html(tdcSidebar.currentViewportSettings.name);a.isUndefined(tdcSidebar.currentViewportSettings.settings.limitBottom)?d.attr("min",200):d.attr("min",tdcSidebar.currentViewportSettings.settings.limitBottom);d.attr("max",tdcSidebar.currentViewportSettings.settings.limitTop);d.attr("value",b);l.html(b+"px")}},100))},_updateData:function(a){var b=a.data("model_id"),c=a.data("param_name"),f=a.closest(".tdc-tab-content");"undefined"===typeof b?tdcCssEditor.saveWidgetForm(a):(a=tdcIFrameData.getModel(b),
f=tdcCssEditor._generateCssAttValue(f),tdcSidebarController.onUpdate(a,c,"",f))},saveWidgetForm:function(a){var b=a.closest("form");a=a.closest(".tdc-tab-content");if(b.length){var c=b.find('input[name="id_base"]').val(),f=b.find('input[name="widget-id"]').val().replace(c+"-","");c="'widget-"+c+"["+f+"][tdc_css]'";f=b.find("input[name="+c+"]");var g=tdcCssEditor._generateCssAttValue(a);a.data("tdc_css",g);f.length?f.val(g):b.append('<input type="hidden" name='+c+' value="'+g+'">')}},addWidgetCssEditor:function(a,
c){tdcCssEditor._mappedParameter=a;return tdcCssEditor._generateEditorContent(c)},addComposerCssEditor:function(a,c){tdcCssEditor._mappedParameter=a;tdcCssEditor._model=c;a=c.get("attrs")[a.param_name];return tdcCssEditor._generateEditorContent(a)},_checkDefaultColor:function(b){var c=b.closest(".tdc-property-wrap").find(".tdc-colorpicker-wrap");""===b.val()&&(b=b.data("default_value"),a.isUndefined(b)?c.attr("style",""):c.attr("style","background-color: "+tdcCssEditor._getRgba(b)))},_generateEditorContent:function(b){if(a.isEmpty(b))tdcCssEditor._currentCssSettings=
c;else try{var e=JSON.parse(window.atob(b));tdcDebug.log(e);a.isObject(e)?tdcCssEditor._currentCssSettings=e:tdcCssEditor._currentCssSettings=c}catch(d){tdcCssEditor._currentCssSettings=c,new tdcNotice.notice(d.message,!1,!1)}tdcSidebarPanel._hook.addAction("panel_rendered",function(){k(".tdc-css-image-wrap").each(function(b,e){b=k(e);e=b.closest(".tdc-property-wrap");var d=e.find(".tdc-css-image-remove"),f=e.find(".tdc-inherit-image"),n={isInherited:!1},h=tdcCssEditor._getSettingsProperty("background-image",
c,n);n.isInherited?e.addClass(tdcCssEditor._INHERITED_CSS_CLASS):e.removeClass(tdcCssEditor._INHERITED_CSS_CLASS);a.isUndefined(h)?(d.addClass("tdc-hidden-button"),f.hide()):("no_value"===h?d.addClass("tdc-hidden-button"):(d.removeClass("tdc-hidden-button"),b.attr("style",'background-image: url("'+h+'")')),"all"!==tdcSidebar.currentViewportSettings.name&&f.show());b.data("image_link",h)});k(".tdc-inherit").each(function(b,e){b=k(e);e=b.closest(".tdc-property-wrap");if("all"===tdcSidebar.currentViewportSettings.name||
e.hasClass(tdcCssEditor._INHERITED_CSS_CLASS))b.hide();else{var d=e.data("tdc-for");e={isInherited:!1};d=tdcCssEditor._getSettingsProperty(d,c,e);e.isInherited?b.hide():a.isUndefined(d)||b.show()}})});return tdcCssEditor.generateEditorResponsiveContent()},_cleanCss:function(b,e){if("undefined"===typeof e)return c;if("no_value"===e)return e;if("background-image"===b)return b=/(url\s*\(\s*['"]?)(.*?)\s*(['"]?\s*\))/ig.exec(e),a.isEmpty(b)?"":b[2];e=e.toLowerCase();e=e.replace(/!important/g,"");return e.trim()},
_getDataNoValue:function(a){var b="";"no_value"===a&&(b=' data-no_value="1" ');return b},callbackColorPicker:function(){k(".tdc-tab-design .tdc-property-colorpicker").each(function(){k("#tdc-palette-color-picker").tdPalette();var b=k(this),c=b.find("input"),d=b.closest(".tdc-property-wrap");b=b.find(".tdc-colorpicker-wrap");a.isUndefined(c.val())||""===c.val()||b.attr("style","background: "+c.val());d.hasClass(tdcCssEditor._INHERITED_CSS_CLASS)?""!==c.attr("placeholder")&&b.attr("style","background-color: "+
tdcCssEditor._getRgba(c.attr("placeholder"))):("no_value"===c.val()&&c.val(""),tdcCssEditor._checkDefaultColor(c))})},generateEditorResponsiveContent:function(){function b(){return n={isInherited:!1}}function e(a){return"all"!==tdcSidebar.currentViewportSettings.name?'placeholder="'+a+'"':""}function d(){return n.isInherited?" "+tdcCssEditor._INHERITED_CSS_CLASS:""}function f(a,c){c=tdcCssEditor._getSettingsProperty(a,c,b());var e="-";n.isInherited&&(e=c,c="");return'<input data-tdc-for="'+a+'" name="" type="text" value="'+
c+'" class="tdc-css-box-input tdc-css-box-input-'+a+d()+'" title="Css '+a+'" placeholder="'+e+'" '+tdcSidebarPanel._getParamterDataAtts(g,l)+"/>"}tdcSidebarPanel._hook.removeAction("panel_css");var g=tdcCssEditor._mappedParameter,l=tdcCssEditor._model,n={isInherited:!1};var h='<div class="tdc-responsiveness"><div class="'+(tdcSidebarPanel._getParameterClasses(g)+'">');h=h+'<div class="tdc-box-margin"><div class="tdc-margin-label">Margin</div>'+f("margin-top","");h+=f("margin-right","");h+=f("margin-bottom",
"");h+=f("margin-left","");h=h+'<div class="tdc-box-border"><div class="tdc-border-label">Border</div>'+f("border-top-width","");h+=f("border-right-width","");h+=f("border-bottom-width","");h+=f("border-left-width","");h=h+'<div class="tdc-box-padding"><div class="tdc-padding-label">Padding</div>'+f("padding-top","");h+=f("padding-right","");h+=f("padding-bottom","");h+=f("padding-left","");h+="</div></div></div></div>";var m=tdcCssEditor._getSettingsProperty("border-style",c,b());h+='<div class="tdc-property-wrap tdc-border-style tdc-dropdown-big'+
...
{value:"none",display:"None"},{value:"hidden",display:"Hidden"},{value:"double",display:"Double"},{value:"groove",display:"Groove"},{value:"ridge",display:"Ridge"},{value:"inset",display:"Inset"},{value:"outset",display:"Outset"},{value:"initial",display:"Initial"},{value:"inherit",display:"Inherit"}],m);h+="</select></div></div>";m=a.uniqueId();var r=tdcCssEditor._getSettingsProperty("border-color","",b()),p="";n.isInherited&&(p=r,r="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-border-color'+
d()+'" data-tdc-for="border-color">';h=h+'<div class="tdc-property-title"><span title="Css border-color" class="tdc-search-data">Border color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+('<input class="tdc-css-border-color" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(r)+' data-default_value="#888888" id="'+m+'" name="" type="text" '+e(p)+' value="'+r+
'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsProperty("border-radius","",b());r="";n.isInherited&&(r=m,m="");h+='<div class="tdc-property-wrap tdc-border-radius tdc-textfield-small'+d()+'" data-tdc-for="border-radius">';h=h+'<div class="tdc-property-title"><span title="Css border-radius" class="tdc-search-data">Border radius</span></div><div class="tdc-property"><input class="tdc-css-border-radius" '+(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(r)+' value="'+m+'"/>');
h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';m=tdcCssEditor._getSettingsProperty("width","",b());r="";n.isInherited&&(r=m,m="");h+='<div class="tdc-property-wrap tdc-width tdc-textfield-big'+d()+'" data-tdc-for="width">';h=h+'<div class="tdc-property-title"><span title="Css shadow-size" class="tdc-search-data">Width</span></div><div class="tdc-property"><input class="tdc-css-width" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(r)+' value="'+m+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';m=tdcCssEditor._getSettingsProperty("shadow-size","",b());r="";n.isInherited&&(r=m,m="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+d()+'" data-tdc-for="shadow-size">';h=h+'<div class="tdc-property-title"><span title="Css shadow-size" class="tdc-search-data">Shadow size</span></div><div class="tdc-property"><input class="tdc-css-shadow-size" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(r)+' value="'+m+'"/>');h+="</div></div>";m=a.uniqueId();r=tdcCssEditor._getSettingsProperty("shadow-color","",b());p="";n.isInherited&&(p=r,r="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-shadow-color'+d()+'" data-tdc-for="shadow-color">';h=h+'<div class="tdc-property-title"><span title="Css shadow-color" class="tdc-search-data">Shadow color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-shadow-color" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(r)+' data-default_value="#888888" id="'+m+'" name="" type="text" '+e(p)+' value="'+r+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsProperty("shadow-offset-h","",b());r="";n.isInherited&&(r=m,m="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+d()+'" data-tdc-for="shadow-offset-h">';h=h+'<div class="tdc-property-title"><span title="Css shadow-offset-h" class="tdc-search-data">Shadow offset H</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-h" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(r)+' value="'+m+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsProperty("shadow-offset-v","",b());r="";n.isInherited&&(r=m,m="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+d()+'" data-tdc-for="shadow-offset-v">';h=h+'<div class="tdc-property-title"><span title="Css shadow-offset-v" class="tdc-search-data">Shadow offset V</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-v" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(r)+' value="'+m+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';m=a.uniqueId();r=tdcCssEditor._getSettingsProperty("background-color","",b());p="";n.isInherited&&(p=r,r="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-bg-color'+d()+'" data-tdc-for="background-color">';h=h+'<div class="tdc-property-title"><span title="Css background-color" class="tdc-search-data">Background color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-bg-color" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(r)+' id="'+m+'" name="" type="text" '+e(p)+' value="'+r+'"/>');h+="</div></div>";tdcCssEditor._getSettingsProperty("background-image",c,b());h+='<div class="tdc-property-wrap tdc-property-attach_image'+d()+'">';h=h+'<div class="tdc-property-title"><span title="Css background-image" class="tdc-search-data">Background image<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-image"></div></span></div><div class="tdc-property"><div class="tdc-css-bg-image tdc-css-image-wrap " '+
...
"</select></div></div>";m=tdcCssEditor._getSettingsProperty("opacity","",b());r="";n.isInherited&&(r=m,m="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+d()+'" data-tdc-for="opacity">';h=h+'<div class="tdc-property-title"><span title="Css background-image opacity" class="tdc-search-data">Background opacity</span></div><div class="tdc-property"><input class="tdc-css-opacity" '+(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(r)+' value="'+m+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';
m=a.uniqueId();r=tdcCssEditor._getSettingsProperty("color-1-overlay","",b());p="";n.isInherited&&(p=r,r="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-1-overlay'+d()+'" data-tdc-for="color-1-overlay">';h=h+'<div class="tdc-property-title"><span title="Css gradient color From" class="tdc-search-data">Color 1 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-1-overlay" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(r)+' id="'+m+'" name="" type="text" '+e(p)+' value="'+r+'"/>');h+="</div></div>";m=a.uniqueId();r=tdcCssEditor._getSettingsProperty("color-2-overlay","",b());p="";n.isInherited&&(p=r,r="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-2-overlay'+d()+'" data-tdc-for="color-2-overlay">';h=h+'<div class="tdc-property-title"><span  title="Css gradient color To" class="tdc-search-data">Color 2 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-2-overlay" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(r)+' id="'+m+'" name="" type="text" '+e(p)+' value="'+r+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsProperty("gradient-direction","",b());r="";n.isInherited&&(r=m,m="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+d()+'" data-tdc-for="gradient-direction">';h=h+'<div class="tdc-property-title"><span title="Css gradient direction" class="tdc-search-data">Gradient direction</span></div><div class="tdc-property"><input class="tdc-css-gradient-direction" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(r)+' value="'+m+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';m=tdcCssEditor._getSettingsProperty("content-h-align",c,b());h+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+d()+'" data-tdc-for="content-h-align">';h=h+'<div class="tdc-property-title"><span title="Css content horizontal align" class="tdc-search-data">H. align<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-content-h-align" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="">');h+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Default"},{value:"content-horiz-left",display:"Left"},{value:"content-horiz-center",display:"Center"},{value:"content-horiz-right",display:"Right"}],m);h+="</select></div></div>";"vc_row"!==l.get("tag")&&"vc_row_inner"!==l.get("tag")&&"vc_column"!==l.get("tag")&&"vc_column_inner"!==l.get("tag")&&(m=tdcCssEditor._getSettingsProperty("order","",b()),r="",n.isInherited&&(r=m,m=""),h+=
'<div class="tdc-property-wrap tdc-order tdc-textfield-small'+d()+'" data-tdc-for="order">',h=h+'<div class="tdc-property-title"><span title="Order" class="tdc-search-data">Order</span></div><div class="tdc-property"><input class="tdc-css-order" '+(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(r)+' value="'+m+'"/>'),h+="</div></div>");m=tdcCssEditor._getSettingsProperty("z-index","",b());r="";n.isInherited&&(r=m,m="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+
d()+'" data-tdc-for="z-index">';h=h+'<div class="tdc-property-title"><span title="Z-index" class="tdc-search-data">Z-index</span></div><div class="tdc-property"><input class="tdc-css-z-index" '+(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+e(r)+' value="'+m+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsPropertyFromCssSettings("display",c);h+='<div class="tdc-property-wrap tdc-display tdc-dropdown-big'+d()+'" data-tdc-for="display">';h=h+'<div class="tdc-property-title"><span title="Css content horizontal align" class="tdc-search-data">Display</span></div><div class="tdc-property"><select class="tdc-css-display" '+
...
l=b.find(".tdc-css-box-input-margin-left").val().trim(),n=b.find(".tdc-css-box-input-border-top-width").val().trim(),h=b.find(".tdc-css-box-input-border-right-width").val().trim(),m=b.find(".tdc-css-box-input-border-bottom-width").val().trim(),k=b.find(".tdc-css-box-input-border-left-width").val().trim(),p=b.find(".tdc-css-box-input-padding-top").val().trim(),y=b.find(".tdc-css-box-input-padding-right").val().trim(),q=b.find(".tdc-css-box-input-padding-bottom").val().trim(),t=b.find(".tdc-css-box-input-padding-left").val().trim(),
u=b.find(".tdc-css-border-radius").val().trim(),z=b.find(".tdc-css-width").val().trim(),A=b.find(".tdc-css-shadow-size").val().trim(),x=b.find(".tdc-css-shadow-offset-h").val().trim(),w=b.find(".tdc-css-shadow-offset-v").val().trim(),v=b.find(".tdc-css-opacity").val().trim(),B=b.find(".tdc-css-gradient-direction").val().trim(),C=b.find(".tdc-css-z-index").val().trim(),D="";b.find(".tdc-css-order").length&&(D=b.find(".tdc-css-order").val().trim());""!==d&&(c["margin-top"]=d);""!==f&&(c["margin-right"]=
f);""!==g&&(c["margin-bottom"]=g);""!==l&&(c["margin-left"]=l);""!==n&&(c["border-top-width"]=n);""!==h&&(c["border-right-width"]=h);""!==m&&(c["border-bottom-width"]=m);""!==k&&(c["border-left-width"]=k);""!==p&&(c["padding-top"]=p);""!==y&&(c["padding-right"]=y);""!==q&&(c["padding-bottom"]=q);""!==t&&(c["padding-left"]=t);d=b.find(".tdc-css-border-style");f=d.val().trim();""===f||d.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["border-style"]=f);d=b.find(".tdc-css-border-color");
f=d.val().trim();""!==f?c["border-color"]=f:(d=d.data("no_value"),a.isUndefined(d)||1!==d||(c["border-color"]="no_value"));""!==u&&(c["border-radius"]=u);""!==z&&(c.width=z);""!==A&&(c["shadow-size"]=A);u=b.find(".tdc-css-shadow-color");z=u.val().trim();""!==z?c["shadow-color"]=z:(u=u.data("no_value"),a.isUndefined(u)||1!==u||(c["shadow-color"]="no_value"));""!==x&&(c["shadow-offset-h"]=x);""!==w&&(c["shadow-offset-v"]=w);x=b.find(".tdc-css-bg-color");w=x.val().trim();""!==w?c["background-color"]=
w:(x=x.data("no_value"),a.isUndefined(x)||1!==x||(c["background-color"]="no_value"));x=b.find(".tdc-css-bg-image");x.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(x=x.data("image_link"),a.isUndefined(x)||("no_value"===x?c["background-image"]="no_value":""!==x&&(c["background-image"]='url("'+x+'")')));x=b.find(".tdc-css-bg-style");w=x.val().trim();""===w||x.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["background-style"]=w);x=b.find(".tdc-css-bg-position");
w=x.val().trim();""===w||x.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["background-position"]=w);""!==v&&(c.opacity=v);v=b.find(".tdc-css-color-1-overlay");x=v.val().trim();""!==x?c["color-1-overlay"]=x:(v=v.data("no_value"),a.isUndefined(v)||1!==v||(c["color-1-overlay"]="no_value"));v=b.find(".tdc-css-color-2-overlay");x=v.val().trim();""!==x?c["color-2-overlay"]=x:(v=v.data("no_value"),a.isUndefined(v)||1!==v||(c["color-2-overlay"]="no_value"));""!==B&&(c["gradient-direction"]=
B);""!==D&&(c.order=D);""!==C&&(c["z-index"]=C);B=b.find(".tdc-css-content-h-align");C=B.val().trim();""===C||B.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["content-h-align"]=C);b=b.find(".tdc-css-display");c.display=b.val().trim();a.isUndefined(tdcCssEditor._currentCssSettings)&&(tdcCssEditor._currentCssSettings={});a.isUndefined(c["border-style"])||"solid"!==c["border-style"]||("all"===tdcSidebar.currentViewportSettings.name||a.isUndefined(tdcCssEditor._currentCssSettings.all)||
...
function(a){var b=jQuery(this),c=b.closest(".tdc-property-responsive"),d=c.find('input[type="range"]'),f=c.find('input[type="radio"]:checked'),g=c.find('input[type="text"]'),l=d.get(0),n="",h=f.data("default_value"),m=tdcIFrameData.getModel(d.data("model_id")),k=d.data("param_name"),p=window.tdcAdminSettings.mappedShortcodes[m.attributes.tag],y=m="";var q=[];for(var t=0;t<p.params.length;t++)if(k===p.params[t].param_name){t=p.params[t].tdc_values;for(var u in t)t.hasOwnProperty(u)&&(q.push(t[u].unit),
""===m||""===y)&&(m=t[u].value,y=t[u].unit);break}f.length&&(n=f.data("unit_value"));if("range"===b.attr("type"))q=d.val(),g.val(q),f.data("last_value",q),g.val(q),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),q+n,tdcSidebar.currentViewportSettings.name)),c.removeClass("tdc-css-inherited");else if("text"===b.attr("type")){if("input"===a.type||"change"===a.type)return;c.removeClass("tdc-css-inherited");q=g.val().trim();if("all"===tdcSidebar.currentViewportSettings.name)""!==
q||_.isUndefined(h)||""===h?(d.val(q),f.data("last_value",q),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),q+n,tdcSidebar.currentViewportSettings.name))):(d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+k,tdcSidebar.currentViewportSettings.name)),d.data("range_value",m),d.data("range_unit",y),d.val(m),n=c.find('input[type="radio"][data-unit_value="'+y+'"]'),p=n.data("unit"),u=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+p),n.prop("checked",
!0),l.min=u,l.max=f,l.step=p,l.value=m,n.data("last_value",m),g.val(m));else if(""===q)if(n=tdcSidebarPanel.getCurrentResponsiveValue(d.attr("name"),"all"),"undefined"===typeof n)d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+k,tdcSidebar.currentViewportSettings.name)),d.data("range_value",m),d.data("range_unit",y),d.val(m),n=c.find('input[type="radio"][data-unit_value="'+y+'"]'),p=n.data("unit"),u=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+p),n.prop("checked",
!0),l.min=u,l.max=f,l.step=p,l.value=m,n.data("last_value",m),g.val(m),c.addClass("tdc-css-inherited");else for(t=0;t<p.params.length;t++){if(k===p.params[t].param_name){q=[];g=[];t=p.params[t].tdc_values;for(u in t)t.hasOwnProperty(u)&&q.push(t[u].unit);for(t=0;t<q.length&&!(g=n.split(q[t]),1<g.length);t++);g.length&&(m=g[0],y=q[t],d.data("range_value",m),d.data("range_unit",y),n=c.find('input[type="radio"][data-unit_value="'+y+'"]'),p=n.data("unit"),u=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+
p),n.prop("checked",!0),l.min=u,l.max=f,l.step=p,l.value=m,n.data("last_value",m),c.find('input[type="text"]').val(m));d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+k,tdcSidebar.currentViewportSettings.name));c.addClass("tdc-css-inherited");break}}else d.val(q),f.data("last_value",q),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),q+n,tdcSidebar.currentViewportSettings.name))}else if("radio"===b.attr("type")){if("input"===a.type)return;
k=f.data("last_value");p=f.data("unit");u=d.data("min_"+p);f=d.data("max_"+p);p=d.data("step_"+p);l.min=u;l.max=f;l.step=p;""===k?(g.val(h),d.val(h),q=h):(g.val(k),d.val(k),q=k);d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),q+n,tdcSidebar.currentViewportSettings.name));c.removeClass("tdc-css-inherited")}n="";c=jQuery(l).parent().find('input[type="radio"]:checked');c.length&&(n=jQuery(c[0]).data("unit_value"));"focusin"===a.type?l.oldValue=l.value+n:(c=jQuery(l),
...
a.on("keyup",".tdc-property-wrap[data-enable-params] textarea,.tdc-property-wrap[data-enable-params] input[type=text]",function(a){tdcSidebarPanel.toggleEnableParamsFromText(jQuery(this))});a.on("change",".tdc-property-wrap[data-enable-params] select",function(a){tdcSidebarPanel.toggleEnableParamsFromSelect(jQuery(this))});a.on("change",".tdc-property-wrap[data-enable-params] input[type=checkbox]",function(a){tdcSidebarPanel.toggleEnableParamsFromCheckbox(jQuery(this))});a.on("mousedown",function(a){var b=
jQuery("#tdc-sidebar"),c=jQuery("#tdc-icon-selector"),d=jQuery("#tdc-gradient"),f=jQuery("#tdc-palette"),g=jQuery("#tdc-font-list"),l=jQuery(".tdc-preset-values-list");c.length?c.get(0).contains(a.target)||(c.hide(),b.after(c)):c=tdcSidebar.buildIconSelector();d.length?d.get(0).contains(a.target)||(c=jQuery(a.target),c.hasClass("tdc-gradient-wrap")||(d.hide(),b.after(d))):d=tdcSidebar.buildGradient();f.length?f.get(0).contains(a.target)||(c=jQuery(a.target),c.hasClass("tdc-colorpicker-wrap")||(f.hide(),
b.after(f),f.find("input.wp-color-picker").tdPaletteColorPicker("save_color"))):f=tdcSidebar.buildPalette();g.length&&!g.get(0).contains(a.target)&&(g.hide(),b.after(g));!l.length||l.get(0).contains(a.target)||jQuery(".tdc-preset-values").get(0).contains(a.target)?l.is(":visible")&&jQuery(".tdc-preset-values").get(0).contains(a.target)&&setTimeout(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn(),
...
_.each(b,function(a,b,c){-1!==_.indexOf(g,b)&&(d[f+b]=a)});e.set({attrs:d,rebindToPanel:!0});tdcSidebarController.onUpdate(e)});a.on("click",".tdc-recent-font-settings",function(){var a=jQuery(this),b=a.data("value"),e=a.data("model_id");e=tdcIFrameData.getModel(e);var d=e.get("attrs");a=a.data("param_name").replace("font_settings","");d[a+"font_family"]=b;e.set({attrs:d,rebindToPanel:!0});tdcSidebarController.onUpdate(e)});tdcSidebarPanel.$_paramSwitchWrap=a.find(".tdc-param-switch-wrap");tdcSidebarPanel.$_paramNameSwitch=
a.find(".tdc-param-name-switch");if(0<tdcSidebarPanel.$_paramNameSwitch.length)a.on("click",".tdc-param-name-switch",function(){jQuery(this).toggleClass("tdc-param-switch-active");jQuery(".tdc-param-name").toggleClass("tdc-param-name-active")});tdcSidebarPanel.$_paramInfoSwitch=a.find(".tdc-param-info-switch");a.on("click",".tdc-param-info-switch",function(){jQuery(this).toggleClass("tdc-param-switch-active");jQuery("#tdc-sidebar").toggleClass("tdc-param-info-active");jQuery.ajax({timeout:1E4,type:"POST",
url:tdcUtil.getRestEndPoint("td-composer/set_param_info_option","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{action:"tdc_ajax_set_param_info_option"}})});a.on("tdc_wm_global_color_name_update",function(a,b){a=b.new_option;var c="var(--"+b.option.replace("_","-")+")",d="var(--"+a.replace("_","-")+")";jQuery(".tdc-property-colorpicker").each(function(){var a=jQuery(this),b=a.find("input");a=a.find(".tdc-colorpicker-wrap");
!_.isUndefined(b.val())&&""!==b.val()&&/var\(--[a-zA-z0-9\-]*\)/.test(b.val())&&b.val()===c&&(b.val(d),a.attr("style","background: "+d),a.attr("title","Global color: "+d),b.trigger("change"))});jQuery(".tdc-property-gradient").each(function(){var a=jQuery(this),b=a.find("input");a=a.find(".tdc-gradient-wrap");!_.isUndefined(b.val())&&""!==b.val()&&/var\(--[a-zA-z0-9\-]*\)/.test(b.val())&&b.val()===c&&(b.val(d),a.attr("style","background: "+d),a.attr("title","Global color: "+d),b.trigger("change"))})});
a.on("keyup","input.tdc-edit-page_id",function(a){console.log(a);var b=jQuery(this).closest(".tdc-property-wrap").find("a.tdc-edit-page_id");""===a.currentTarget.value.trim()?b.hide():b.length&&"undefined"!==typeof window.tdData&&(b.attr("href",tdData.adminUrl+"post.php?post="+a.currentTarget.value.trim()+"&action=edit").show(),b.css("visibility","visible"))})},getCurrentStyleSettings:function(a,c){_.isUndefined(c)&&(c=jQuery(a.currentTarget).data("model_id"),c=tdcIFrameData.getModel(c),a={error:k},
_.isUndefined(c)||tdcIFrameData._checkModelData(c,a));var b=c.get("tag");c=c.get("attrs");c=_.clone(c);if(!_.isUndefined(c)){var e={};a={};for(var d in c)0===d.indexOf("tds_")&&(e[d]=c[d]);d=window.tdcAdminSettings.mappedShortcodes[b].params;for(b=0;b<d.length;b++){var f=!1,g=d[b];if(0===g.param_name.indexOf("tds_")){for(var l in e)if(g.param_name===l){a[l]=e[l];f=!0;break}f||(a[g.param_name]="")}}for(l in e)switch(e=l.split("-"),e.length){case 2:if(!_.has(a,l)){d=e[0];e=!1;for(var n in a)if(d===
a[n]&&1===n.split("-").length){e=!0;break}if(!e){var h;for(h in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[h],d)){var m=h;break}_.has(a,m)&&""===a[m]&&window.tdcAdminSettings.globalStyle[m]===d&&(e=!0)}e||delete c[l]}break;case 3:d=e[0];b=e[2];for(h in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[h],d)){m=h;break}e=!1;for(n in a)if(d===a[n]&&n===m+"-"+b){e=!0;break}e||_.has(a,m+"-"+b)&&""===a[m+"-"+b]&&window.tdcAdminSettings.globalStyle[m]===
d&&(e=!0);e||delete c[l]}return c}},getCurrentListAtts:function(a,c,b){_.isUndefined(c)&&(a=jQuery(a.currentTarget).data("model_id"),c=tdcIFrameData.getModel(a),a={error:k},_.isUndefined(c)||tdcIFrameData._checkModelData(c,a));a=c.get("tag");c=c.get("attrs");var e=_.clone(c);if(!_.isUndefined(e)){var d={};c={};for(var f in e)0===f.indexOf("tds_")&&(d[f]=e[f]);f=window.tdcAdminSettings.mappedShortcodes[a].params;for(var g=0;g<f.length;g++){var l=!1,n=f[g];if(0===n.param_name.indexOf("tds_")){for(var h in d)if(n.param_name===
h){c[h]=d[h];l=!0;break}l||(c[n.param_name]="")}}for(h in d)switch(d=h.split("-"),d.length){case 2:if(!_.has(c,h)){f=d[0];d=!1;for(var m in c)if(f===c[m]&&1===m.split("-").length){d=!0;break}if(!d){var r;for(r in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[r],f)){var p=r;break}_.has(c,p)&&""===c[p]&&window.tdcAdminSettings.globalStyle[p]===f&&(d=!0)}d||delete e[h]}break;case 3:f=d[0];l=d[2];for(r in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[r],
f)){p=r;break}d=!1;for(m in c)if(f===c[m]&&m===p+"-"+l){d=!0;break}d||_.has(c,p+"-"+l)&&""===c[p+"-"+l]&&window.tdcAdminSettings.globalStyle[p]===f&&(d=!0);d||delete e[h]}var y=[],q;for(q in window.tdcAdminSettings.listStyles[b])if(q===a){for(g=0;g<window.tdcAdminSettings.listStyles[b][q].length;g++)h=window.tdcAdminSettings.listStyles[b][q][g],_.isArray(h)?_.map(h,function(a){_.isUndefined(e[a])||(_.isUndefined(y[g])&&(y[g]=[]),y[g].push(e[a]))}):_.isUndefined(e[h])||(_.isArray(e[h])&&e[h].length?
y[g]=e[h][0]:y[g]=e[h]);break}return y}},showHideTdcCssEditor:function(a){a=jQuery("#tdc-editor-css");var c=jQuery(this).closest(".tdc-property-wrap"),b=c.find("textarea:first");a.length||tdcSidebar.buildEditorCss();tdcSidebar.$editorTextarea=b;c.next(".tdc-property-editor_css-title").length?(c.next(".tdc-property-editor_css-title").toggle(),a.toggle()):(c.after(a),c.after('<div class="tdc-property-editor_expand tdc-property-editor_css-title"><span></span><div class="tdc-editor-toggle tdc-css-ace-editor-expand-collapse"></div></div>'),
a.show(),tdcSidebar.editorCss.getSession().setValue(b.val()))},toggleEnableParamsFromText:function(a){var c=a.closest(".tdc-property-wrap"),b=c.data("enable-params");c=c.data("enable-params-reverse");b=jQuery('.tdc-property-wrap[data-enabled-by="'+b+'"]');b.length&&(""!==a.val()?"undefined"!==typeof c&&1===c?b.hasClass("tdc-disabled")||b.addClass("tdc-disabled"):b.hasClass("tdc-disabled")&&b.removeClass("tdc-disabled"):"undefined"!==typeof c&&1===c?b.hasClass("tdc-disabled")&&b.removeClass("tdc-disabled"):
b.hasClass("tdc-disabled")||b.addClass("tdc-disabled"))},toggleEnableParamsFromSelect:function(a){var c=a.val();a=a.closest(".tdc-property-wrap");var b=a.data("enable-params"),e=a.data("enable-params-reverse");a=jQuery('.tdc-property-wrap[data-enabled-by^="'+b+'"]');a.length&&a.each(function(a,b){a=jQuery(b);-1!==a.data("enabled-by").indexOf("-"+c)?"undefined"!==typeof e&&1===e?a.hasClass("tdc-disabled")||a.addClass("tdc-disabled"):a.hasClass("tdc-disabled")&&a.removeClass("tdc-disabled"):"undefined"!==
typeof e&&1===e?a.hasClass("tdc-disabled")&&a.removeClass("tdc-disabled"):a.hasClass("tdc-disabled")||a.addClass("tdc-disabled")})},toggleEnableParamsFromCheckbox:function(a){var c=a.closest(".tdc-property-wrap"),b=c.data("enable-params");c=c.data("enable-params-reverse");b=jQuery('.tdc-property-wrap[data-enabled-by="'+b+'"]');b.length&&(a.is(":checked")?"undefined"!==typeof c&&1===c?b.hasClass("tdc-disabled")||b.addClass("tdc-disabled"):b.hasClass("tdc-disabled")&&b.removeClass("tdc-disabled"):"undefined"!==
typeof c&&1===c?b.hasClass("tdc-disabled")&&b.removeClass("tdc-disabled"):b.hasClass("tdc-disabled")||b.addClass("tdc-disabled"))},showHideTdcPalette:function(a){a=jQuery("#tdc-palette");var c=jQuery(this).closest(".tdc-property-wrap");a.length||tdcSidebar.buildPalette();c.next("#tdc-palette").length?(a.toggle(),tdcSidebarPanel.saveTdcPalette()):(tdcSidebarPanel.saveTdcPalette(),c.after(a),a.show(),tdcSidebarPanel.openTdcPalette())},saveTdcPalette:function(){var a=jQuery("#tdc-palette"),c=a.prev(".tdc-property-wrap");
a.length||tdcSidebar.buildPalette();c.length&&(c=c.find("input").val(),a=a.find("input.wp-color-picker"),a.tdPaletteColorPicker("open_palette",c),a.tdPaletteColorPicker("save_color"))},openTdcPalette:function(){var a=jQuery("#tdc-palette"),c=a.prev(".tdc-property-wrap");a.length||tdcSidebar.buildPalette();c.length&&(c=c.find("input").val(),a.find("input.wp-color-picker").tdPaletteColorPicker("open_palette",c))},tdcIconWrapHandler:function(a){var c=jQuery(this),b=jQuery("#tdc-icon-selector");b.length||
(b=tdcSidebar.buildIconSelector());var e=c.closest(".tdc-property-wrap");a=b.find(".tdc-icon-selector-filter");var d=b.find(".tdc-icon-selector-lib"),f=b.find(".tdc-icon-selector-content");d.val("");a.val("");f.children().each(function(){jQuery(this).show()});b.data("model_id",c.data("model_id"));b.data("param_name",c.data("param_name"));b.show();e.after(b);c=b.data("param_name");b=tdcIFrameData.getModel(b.data("model_id")).get("attrs");var g="";_.has(b,c)&&(g=b[c].trim());a.focus();f.find("span").each(function(){var a=
jQuery(this),b=a.data("font_class");if(g===b){for(a.addClass("selected");!a.prev(".tdc-font-separator").length;)a=a.prev();a=a.prev(".tdc-font-separator").data("font_id");d.val(a);d.trigger("change")}else a.removeClass("selected")})},tdcIconRemoveHandler:function(a){var c=jQuery(a.currentTarget);a=c.closest(".tdc-property-wrap").find(".tdc-icon-wrap");c.addClass("tdc-hidden-button");a.addClass("tdc-no-icon-selected");a.html("");c=a.data("model_id");c=tdcIFrameData.getModel(c);tdcSidebarController.onUpdate(c,
a.data("param_name"),"","")},tdcImageWrapHandler:function(a){var c=jQuery(a.currentTarget);c.closest(".tdc-tab-content");window.original_send_to_editor=window.send_to_editor;wp.media.editor.open(c);jQuery(".media-menu .media-menu-item:nth-of-type(2)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(3)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(4)").addClass("hidden");window.send_to_editor=function(a){if(-1!==a.indexOf("[caption")){var b=/\[caption(.*)\](.*)\[\/caption\]/g.exec(a);
3===b.length&&(a=b[2])}var d=jQuery("img",a).attr("src"),f=b="",g="";"undefined"===typeof d?(a=jQuery(a),d=a.attr("src"),b=a.attr("class"),f=a.attr("height"),g=a.attr("width")):(a=jQuery("img",a),b=a.attr("class"),f=a.attr("height"),g=a.attr("width"));jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_id","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_class:b,
action:"tdc_ajax_get_image_id"}}).done(function(a,b,e){"success"===b&&(_.isObject(a)&&_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(c.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button"),c.attr("style","background-image: url( '"+d+"') "),c.data("image_link",d),c.data("image_id",a.image_id),c.data("image_height",f),c.data("image_width",g),c.removeClass("tdc-no-image-selected"),window.send_to_editor=window.original_send_to_editor,window.tb_remove(),b="",e=c.data("model_id"),
e=tdcIFrameData.getModel(e),c.hasClass("tdc-no-image-selected")||(b=a.image_id.toString()),a=e.get("attrs"),a.media_size_image_height=f,a.media_size_image_width=g,e.set("attrs",a),tdcSidebarController.onUpdate(e,c.data("param_name"),"",b)))}).fail(function(a,b,c){})};return!1},tdcImageRemoveHandler:function(a){var c=jQuery(a.currentTarget);a=c.closest(".tdc-property-wrap").find(".tdc-image-wrap");c.addClass("tdc-hidden-button");a.addClass("tdc-no-image-selected");jQuery.removeData(a,"image_link");
...
l="";for(e=0;e<b.length;e++){f=tdcSidebarPanel._fixGroupName(b[e]);m=tdcUtil.makeSafeForCSS(f);f="tdc-tab-no-design";var k=a.get("tag");"css"===m&&(f="tdc-tab-design");0===e?(l='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+m+'">',n='<div class="tdc-tab-content '+f+'" id="td-tab-'+m+'">',m=window.tdcAdminSettings.mappedShortcodes[k].tdc_start_values,a.unset("presetValues"),_.isUndefined(m)||(m=JSON.parse(window.atob(m)),_.isArray(m)&&1<m.length&&a.set("presetValues",m)),
a.has("presetValues")&&(m=a.get("presetValues"),h+=tdcSidebarPanel._addPresetValuesSelector(m,a))):_.isUndefined(g)||g!=="td-tab-"+m?h+='<div class="tdc-tab-content '+f+'" id="td-tab-'+m+'">':(l=n,h+='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+m+'">');h+=tdcSidebarPanel._bindGroupAndGetHtml(b[e],c,a);m=' data-model_id="'+a.cid+'" ';"dev"===window.tdcAdminSettings.deployMode&&(h+='<div class="tdc-sidebar-row-buttons">',h+='<div class="tdc-sidebar-button tdc-sidebar-shortcode-row" '+
...
jQuery(".tdc-tab-no-design .tdc-property-colorpicker").each(function(){var a=jQuery(this),c=a.find("input");a=a.find(".tdc-colorpicker-wrap");_.isUndefined(c.val())||""===c.val()||(a.attr("style","background: "+c.val()),/var\(--[a-zA-z0-9\-]*\)/.test(c.val())&&(a.append('<i class="tdc-font-tdmp tdc-font-tdmp-globe"></i>'),a.attr("title","Global color: "+c.val())))})},addGradient:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,
"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var l="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(l='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+
'" '+b+" "+e+" "+f+" "+g+" "+l+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><div class="tdc-gradient-wrap tdc-no-gradient-selected"></div><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(a,c)+'"/>');b=b+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");b+="</div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",
tdcSidebarPanel.callbackGradient)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackGradient);return b},callbackGradient:function(){jQuery("#tdc-gradient-color-picker").tdGradient();jQuery(".tdc-property-gradient").each(function(){var a=jQuery(this),c=a.find("input");a=a.find(".tdc-gradient-wrap");if(!_.isUndefined(c.val())&&""!==c.val())try{var b=JSON.parse(window.atob(c.val()));_.isUndefined(b.css)||a.attr("style",b.css)}catch(e){b=c.val(),_.isUndefined(b)||(a.attr("style",
"background: "+b),/var\(--[a-zA-z0-9\-]*\)/.test(c.val())&&(a.append('<i class="tdc-font-tdmp tdc-font-tdmp-globe"></i>'),a.attr("title","Global color: "+b)))}})},addDropDown:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');if("tdb_mobile_menu"===c.get("tag")&&"menu_id"===a.param_name){var d=c.get("attrs");d.menu_id=window.tdcPostSettings.mobileMenuId;c.set("attrs",d)}var f=d=!1;_.has(a,"tdc_dropdown_images")&&""!==a.tdc_dropdown_images&&(d=!0);
_.has(a,"tdc_dropdown_texts")&&""!==a.tdc_dropdown_texts&&(f=!0);var g="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(g='data-enable-params="'+a.toggle_enable_params+'"');var l="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(l='data-enable-params-reverse="1"');var n="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(n='data-enabled-by="'+a.toggle_enabled_by+'"');var h="",m="",k=Object.keys(a.value);if(_.has(a,"tdc_min_options")&&k.length<=
parseInt(a.tdc_min_options))return h;for(var p=0;p<k.length;p++){var y=!1,q="",t="",u=k[p],z=String(tdcSidebarPanel._getParameterCurrentValue(a,c)),A=String(a.value[k[p]]);_.isObject(a.value[k[p]])&&(y=!0,A=_.values(a.value[k[p]])[0],u=_.keys(a.value[k[p]])[0]);d||f?(0===p&&""===z&&(z=A),z===A&&(q=" checked "),t=_.uniqueId(),z=A,"vc_row"!==c.attributes.tag&&"vc_row_inner"!==c.attributes.tag||-1!==a.param_name.indexOf("flex_")||(z="col_"+z),m+='<input class="tdc-property-input-radio" type="radio" '+
tdcSidebarPanel._getParamterDataAtts(a,c)+' id="'+t+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+q+' value="'+A+'">',d?(q="",y&&(q="tdc-standard-value"),m+='<label class="tdc-property-input-radio-label '+q+'" for="'+t+'" title="'+u+'"><div class="'+z+'"></div></label>'):m+='<label class="tdc-property-input-radio-label" for="'+t+'" title="'+u+'">'+A+"</label>"):(z===A&&(q=' selected="selected" '),"__"===A&&-1!==u.search("--")&&(t=" disabled "),m+="<option "+q+" "+t+' value="'+A+'">'+u+"</option>")}k=
"";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':k=' title="'+a.description+'" ');h+='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+g+" "+l+" "+n+">";h+='<div class="tdc-property-title"><span class="tdc-search-data"'+k+">"+a.heading+"</span></div>";h+='<div class="tdc-property">';d||f?h+=m:(h+="<select "+tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'">',h=h+m+"</select>");h=h+'</div><span class="tdc-param-name">'+
(a.param_name+"</span>");return h+"</div>"},addDropDownResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d=!1,f=!1;_.has(a,"tdc_dropdown_images")&&""!==a.tdc_dropdown_images&&(d=!0);_.has(a,"tdc_dropdown_texts")&&""!==a.tdc_dropdown_texts&&(f=!0);var g="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(g='data-enable-params="'+a.toggle_enable_params+'"');var l="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&
(l='data-enable-params-reverse="1"');var n="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(n='data-enabled-by="'+a.toggle_enabled_by+'"');var h="",m="",k=Object.keys(a.value);if(_.has(a,"tdc_min_options")&&k.length<=parseInt(a.tdc_min_options))return h;var p=' data-responsive="" ',y=String(tdcSidebarPanel._getParameterCurrentValue(a,c));try{var q=JSON.parse(window.atob(y));p=' data-responsive="'+y+'" ';"undefined"!==typeof q[tdcSidebar.currentViewportSettings.name]&&(y=q[tdcSidebar.currentViewportSettings.name])}catch(v){}for(q=
0;q<k.length;q++){var t=!1,u="",z="",A=k[q],x=String(a.value[k[q]]);_.isObject(a.value[k[q]])&&(t=!0,x=_.values(a.value[k[q]])[0],A=_.keys(a.value[k[q]])[0]);if(d||f){0===q&&""===y&&(y=x);y===x&&(u=" checked ");z=_.uniqueId();var w=x;"vc_row"!==c.attributes.tag&&"vc_row_inner"!==c.attributes.tag||-1!==a.param_name.indexOf("flex_")||(w="col_"+w);m+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' id="'+z+'" name="'+tdcSidebarPanel._getParameterDomName(a)+
'" '+u+' value="'+x+'" '+p+">";d?(u="",t&&(u="tdc-standard-value"),m+='<label class="tdc-property-input-radio-label '+u+'" for="'+z+'" title="'+A+'"><div class="'+w+'"></div></label>'):m+='<label class="tdc-property-input-radio-label" for="'+z+'" title="'+A+'">'+x+"</label>"}else y===x&&(u=' selected="selected" '),"__"===x.substring(0,2)&&-1!==A.search("--")&&(z=" disabled "),m+="<option "+u+" "+z+' value="'+x+'">'+A+"</option>"}k="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+
a.description+'"':k=' title="'+a.description+'" ');h+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+g+" "+l+" "+n+">";h+='<div class="tdc-property-title"><span class="tdc-search-data"'+k+">"+a.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';h+='<div class="tdc-property">';d||f?h+=m:(h+="<select "+tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+
...
" checked "):""!==g&&(f=" checked ");var l="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(l='data-enable-params="'+a.toggle_enable_params+'"');var n="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(n='data-enable-params-reverse="1"');var h="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(h='data-enabled-by="'+a.toggle_enabled_by+'"');g="";var m=tdcSidebarPanel._getParameterClasses(a);m.includes("tdc-filter-multiple")&&(g=' title="'+a.description+
'" ');b='<div class="'+m+'" '+b+" "+e+" "+l+" "+n+" "+h+'><div class="tdc-property-title"><span class="tdc-search-data"'+(d+">"+a.heading+"</span></div>");b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="checkbox" value="yes" '+f+" "+g+"/>");b=b+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return b+"</div>"},addCheckBoxResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&
(b='data-info-img="'+a.info_img+'"');var d="",f=' data-responsive="" ',g=String(tdcSidebarPanel._getParameterCurrentValue(a,c));try{var l=JSON.parse(window.atob(g));f=' data-responsive="'+g+'" ';"undefined"!==typeof l[tdcSidebar.currentViewportSettings.name]&&(g=l[tdcSidebar.currentViewportSettings.name])}catch(m){}""!==g&&(d=" checked ");l="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':l=' title="'+a.description+'" ');g="";_.has(a,"toggle_enable_params")&&
""!==a.toggle_enable_params&&(g='data-enable-params="'+a.toggle_enable_params+'"');var n="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(n='data-enable-params-reverse="1"');var h="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(h='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+g+" "+n+" "+h+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+
l+">"+a.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-checkbox" style="display: block;"></div></span></div>';b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="checkbox" value="yes" '+d+f+"/>");b=b+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return b+"</div>"},addRange:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+
a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"range_max")&&""!==a.range_max&&(f=a.range_max);var g="";_.has(a,"range_min")&&""!==a.range_min&&(g=a.range_min);var l="";_.has(a,"range_step")&&""!==a.range_step&&(l=a.range_step);var n="";_.has(a,"value")&&""!==a.value&&(n=a.value);var h="";""!==tdcSidebarPanel._getParameterCurrentValue(a,c)&&(h=tdcSidebarPanel._getParameterCurrentValue(a,
c));var m="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(m='data-enable-params="'+a.toggle_enable_params+'"');var k="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var p="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(p='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+m+" "+k+" "+p+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+
d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" data-value="'+h+'" data-min="'+g+'" data-max="'+f+'" data-step="'+l+'" min="'+g+'" max="'+f+'" step="'+l+'" value="'+h+'" />');b=b+('<input type="text" class="tdc_range_value" data-default_value="'+n+'" value="'+h+'"/></div><span class="tdc-param-name">')+(a.param_name+"</span>");return b+="</div>"},addRangeResponsive:function(a,
c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"range_max")&&""!==a.range_max&&(f=a.range_max);var g="";_.has(a,"range_min")&&""!==a.range_min&&(g=a.range_min);var l="";_.has(a,"range_step")&&""!==a.range_step&&(l=a.range_step);var n="";_.has(a,"value")&&""!==a.value&&(n=a.value);""!==tdcSidebarPanel._getParameterCurrentValue(a,
c)&&tdcSidebarPanel._getParameterCurrentValue(a,c);var h="";_.has(a,"placeholder")&&""!==a.placeholder&&(h=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var m="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(m='data-enable-params="'+a.toggle_enable_params+'"');var k="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var p="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(p='data-enabled-by="'+
a.toggle_enabled_by+'"');var y=' data-responsive="" ',q=tdcSidebarPanel._getParameterCurrentValue(a,c);try{var t=JSON.parse(window.atob(q));y=' data-responsive="'+q+'" ';q="undefined"===typeof t[tdcSidebar.currentViewportSettings.name]?"":t[tdcSidebar.currentViewportSettings.name]}catch(u){}b='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+m+" "+k+" "+p+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";
b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" data-value="'+q+'" data-min="'+g+'" data-max="'+f+'" data-step="'+l+'" min="'+g+'" max="'+f+'" step="'+l+'" value="'+q+'" '+y+" />");b=b+('<input type="text" class="tdc_range_value" data-default_value="'+n+'" '+h+' value="'+q+'"/></div><span class="tdc-param-name">')+(a.param_name+"</span>");return b+="</div>"},addRangeMultiple:function(a,c){var b="",
...
""!==a.toggle_enabled_by&&(l='data-enabled-by="'+a.toggle_enabled_by+'"');var n=a.tdc_values,h=tdcSidebarPanel._getParameterCurrentValue(a,c),m="",k="",p=[],y="",q="",t="",u="",z="",A="",x="",w;for(w in n)n.hasOwnProperty(w)&&(p.push(n[w].unit),""===q||""===y)&&(u=n[w].unit,q=' data-range_unit="'+u+'" ',t=n[w].value,y=' data-range_value="'+t+'" ',z=n[w].range_min,A=n[w].range_max,x=n[w].range_step);if(""!==h){for(var v=[],B=0;B<p.length&&!(v=h.split(p[B]),1<v.length);B++);v.length&&(u=p[B],q=' data-range_unit="'+
u+'" ',t=v[0],y=' data-range_value="'+t+'" ')}for(w in n)n.hasOwnProperty(w)&&(h=_.uniqueId(),m+=" data-value_"+w+'="'+n[w].value+'" ',m+=" data-min_"+w+'="'+n[w].range_min+'" ',m+=" data-max_"+w+'="'+n[w].range_max+'" ',m+=" data-step_"+w+'="'+n[w].range_step+'" ',p=n[w].value,v="",n[w].unit===u&&(p=t,z=n[w].range_min,A=n[w].range_max,x=n[w].range_step,v="checked"),k+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+'_unit" data-unit="'+w+'" data-unit_value="'+n[w].unit+'" type="radio" id="'+
h+'" '+v+' data-default_value="'+n[w].value+'" data-last_value="'+p+'"/>',k+='<label for="'+h+'">'+n[w].unit+"</label>");b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+l+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+y+" "+q+" "+
m+' min="'+z+'" max="'+A+'" step="'+x+'" value="'+t+'"/>');b=b+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+k+'</div><input type="text" class="tdc_range_value" value="'+(t+'"/>');b+="</div>";b+="</div>";b+='<span class="tdc-param-name">'+a.param_name+"</span>";return b+="</div>"},addRangeMultipleResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==
...
c),m="",k="",p=[],y=' data-responsive="" ',q="",t="",u="",z="",A="",x="",w="",v;for(v in n)n.hasOwnProperty(v)&&(p.push(n[v].unit),""===t||""===q)&&(z=n[v].unit,t=' data-range_unit="'+z+'" ',u=n[v].value,q=' data-range_value="'+u+'" ',A=n[v].range_min,x=n[v].range_max,w=n[v].range_step);if(""!==h){var B=h;try{var C=JSON.parse(window.atob(h));y=' data-responsive="'+h+'" ';B="undefined"===typeof C[tdcSidebar.currentViewportSettings.name]?"":C[tdcSidebar.currentViewportSettings.name]}catch(D){}if(""!==
B){h=[];for(C=0;C<p.length&&!(h=B.split(p[C]),1<h.length);C++);h.length&&(z=p[C],t=' data-range_unit="'+z+'" ',u=h[0],q=' data-range_value="'+u+'" ')}}for(v in n)n.hasOwnProperty(v)&&(p=_.uniqueId(),m+=" data-value_"+v+'="'+n[v].value+'" ',m+=" data-min_"+v+'="'+n[v].range_min+'" ',m+=" data-max_"+v+'="'+n[v].range_max+'" ',m+=" data-step_"+v+'="'+n[v].range_step+'" ',B=n[v].value,h="",n[v].unit===z&&(B=u,A=n[v].range_min,x=n[v].range_max,w=n[v].range_step,h="checked"),k+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+
'_unit" data-unit="'+v+'" data-unit_value="'+n[v].unit+'" type="radio" id="'+p+'" '+h+' data-default_value="'+n[v].value+'" data-last_value="'+B+'"/>',k+='<label for="'+p+'">'+n[v].unit+"</label>");b='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+l+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(a,
c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+q+" "+t+" "+m+" "+y+' min="'+A+'" max="'+x+'" step="'+w+'" value="'+u+'"/>');b=b+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+k+'</div><input type="text" class="tdc_range_value" value="'+(u+'"/>');b+="</div>";b+="</div>";b+='<span class="tdc-param-name">'+a.param_name+"</span>";return b+="</div>"},addIconSelector:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+
a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var l="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(l='data-enabled-by="'+a.toggle_enabled_by+
'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+l+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><div class="tdc-icon-wrap tdc-no-icon-selected" '+(tdcSidebarPanel._getParamterDataAtts(a,c)+">");b=b+'</div><a class="tdc-icon-remove tdc-hidden-button" href="#" >Remove</a></div><span class="tdc-param-name">'+(a.param_name+"</span>");b+="</div>";tdcSidebarPanel._hook.addAction("panel_rendered",
function(){jQuery(".tdc-icon-wrap").each(function(b,d){b=jQuery(d);a.param_name===b.data("param_name")&&(d=jQuery("#tdc-icon-selector"),d.length||(d=tdcSidebar.buildIconSelector()),d=d.find('.tdc-icon-selector-content > span[data-font_class="'+tdcSidebarPanel._getParameterCurrentValue(a,c)+'"]'),""!==tdcSidebarPanel._getParameterCurrentValue(a,c)&&(b.html(d.html()),b.closest(".tdc-property").find(".tdc-icon-remove").removeClass("tdc-hidden-button")))})});return b},addUploadImage:function(a,c){var b=
"",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var l="";_.has(a,"toggle_enabled_by")&&
""!==a.toggle_enabled_by&&(l='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+l+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><div class="tdc-image-wrap tdc-no-image-selected" '+(tdcSidebarPanel._getParamterDataAtts(a,c)+" style=\"background-image: url('"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png')\">");
...
'" placeholder="'+a.placeholder+'" ');var l=tdcSidebarPanel._getParameterCurrentValue(a,c);"modal_id"===a.param_name&&""===l&&(l="td_m_"+Math.floor(65536*(1+Math.random())).toString(16).substring(1),tdcSidebarController.onUpdate(c,"modal_id","",l));"undefined"!==typeof l&&null!==l&&0===l.toString().indexOf("td_encval")&&(l=l.replace("td_encval",""),l=window.atob(l));var n="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(n='data-enable-params="'+a.toggle_enable_params+'"');var h="";
_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(h='data-enable-params-reverse="1"');var k="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(k='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+n+" "+h+" "+k+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span>";d="";e="#";"tdm_block_popup"===c.get("tag")&&"page_id"===a.param_name&&(d="tdc-edit-page_id",
n='style="margin-left: 10px"',_.has(c.get("attrs"),"page_id")?""===c.get("attrs").page_id.trim()?n='style="margin-left: 10px; visibility: hidden"':"undefined"!==typeof window.tdData&&(e=tdData.adminUrl+"post.php?post="+c.get("attrs").page_id.trim()+"&action=edit"):n='style="margin-left: 10px; visibility: hidden"',b+='<a href="'+e+'" class="'+d+'" target="_blank" '+n+">Edit</a>");b=b+'</div><div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+
...
(k='data-enable-params-reverse="1"');var h="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(h='data-enabled-by="'+a.toggle_enabled_by+'"');var m=' data-responsive="" ',r=tdcSidebarPanel._getParameterCurrentValue(a,c);try{var p=JSON.parse(window.atob(r));m=' data-responsive="'+r+'" ';r="undefined"===typeof p[tdcSidebar.currentViewportSettings.name]?"":p[tdcSidebar.currentViewportSettings.name]}catch(y){}b='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+
b+" "+e+" "+l+" "+k+" "+h+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="text" value="'+r+'" '+g+m+d+"/>");b=b+f+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return b+="</div>"},addTextAreaHtml:function(a,c){_.has(a,"description");return'<a href="#" class="tdc-open-wpeditor" data-model_id="'+
c.cid+'" data-mapped_parameter_name="'+a.param_name+'">Edit Content</a>'},addTextAreaRawHtml:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d=_.uniqueId("tdc_textarea_"),f="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':f=' title="'+a.description+'" ');var g="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(g='data-enable-params="'+a.toggle_enable_params+'"');var l="";_.has(a,
"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(l='data-enable-params-reverse="1"');var k="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(k='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+g+" "+l+" "+k+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+f+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><textarea id="'+(d+'" class="tdc-textarea" '+tdcSidebarPanel._getParamterDataAtts(a,
c)+">"+tdcSidebarPanel._getParameterCurrentValue(a,c)+"</textarea>");b=b+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");b+="</div>";jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/decode_html_content","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{post_id:window.tdcPostSettings.postId,action:"tdc_ajax_decode_html_content",content:tdcSidebarPanel._getParameterCurrentValue(a,
...
"undefined"!==typeof a.loop_spot&&!0===a.loop_spot?c+'<span class="tdc-loop-spot-header-title">Title</span><span class="tdc-loop-spot-header-paragraph">Repeat</span><span class="tdc-loop-spot-header-color">Color</span><span class="tdc-loop-spot-header-full">Full</span>':c+'<span class="tdc-spot-header-title">Title</span><span class="tdc-spot-header-color">Color</span>';return c+"</div>"},addFilterHeader:function(a,c){return'<div class="tdc-filter-header '+tdcSidebarPanel._getParameterClasses(a)+'"><span class="tdc-filter-header-name">Name</span><span class="tdc-filter-header-type" title="Select the type of attribute">Type</span><span class="tdc-filter-header-multiple" title="Allow multiple selection">Multi</span></div>'},
addFilterTitle:function(a,c){var b="",e="",d="";_.has(a,"info_img")&&""!==a.info_img&&(e='data-info-img="'+a.info_img+'"',_.has(a,"description")&&""!==a.description&&(d='data-info-descr="'+a.description+'"'));var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var l="";_.has(a,"toggle_enabled_by")&&""!==
a.toggle_enabled_by&&(l='data-enabled-by="'+a.toggle_enabled_by+'"');return b+='<div class="tdc-sidebar-filter-title '+tdcSidebarPanel._getParameterClasses(a)+'" '+e+" "+d+" "+f+" "+g+" "+l+'><span class="tdc-search-data">'+tdcSidebarPanel._getParameterCurrentValue(a,c)+"</span></div>"},addClearfix:function(a,c){return'<div class="clearfix"></div>'},updateTextfieldResponsiveValues:function(a,c,b){"undefined"===typeof window.tdcResponsiveValues[a]?""!==c&&(window.tdcResponsiveValues[a]={},window.tdcResponsiveValues[a][b]=
...
""},deleteResponsiveValues:function(a){"undefined"!==typeof window.tdcResponsiveValues[a]&&(window.tdcResponsiveValues[a]={})},getCurrentResponsiveValue:function(a,c){if("undefined"!==typeof window.tdcResponsiveValues[a])return window.tdcResponsiveValues[a][c]},setViewportCurrentResponsiveValue:function(a){var c=tdcSidebarPanel.getCurrentResponsiveValue(a.attr("name"),tdcSidebar.currentViewportSettings.name),b=a.closest(".tdc-property-responsive");if(b.hasClass("tdc-property-textfield-responsive")){var e=
"";_.isUndefined(a.data("placeholder"))||(e=a.data("placeholder"));a.attr("placeholder",e);_.isUndefined(c)?(c=tdcSidebarPanel.getCurrentResponsiveValue(a.attr("name"),"all"),_.isUndefined(c)?a.val(""):(a.val(c),a.attr("placeholder",c),b.addClass("tdc-css-inherited"))):(a.val(c),b.removeClass("tdc-css-inherited"))}else if(b.hasClass("tdc-property-checkbox-responsive"))e=b.find(".tdc-inherit-checkbox"),_.isUndefined(c)?(c=tdcSidebarPanel.getCurrentResponsiveValue(a.attr("name"),"all"),_.isUndefined(c)?
a.removeAttr("checked"):(""===c?a.removeAttr("checked"):a.attr("checked","checked"),b.addClass("tdc-css-inherited")),e.hide()):(""===c?a.removeAttr("checked"):a.attr("checked","checked"),b.removeClass("tdc-css-inherited"),"all"===tdcSidebar.currentViewportSettings.name?e.hide():e.show());else if(b.hasClass("tdc-property-dropdown-responsive")){e=b.find(".tdc-inherit-select");var d=a.attr("type");_.isUndefined(c)?(c=tdcSidebarPanel.getCurrentResponsiveValue(a.attr("name"),"all"),_.isUndefined(c)?"undefined"!==
typeof d&&"radio"===d?a.each(function(a){var b=jQuery(this);"radio"===b.attr("type")&&(0===a?b.prop("checked",!0):b.prop("checked",!1))}):a.find("option:selected").removeAttr("selected").find("option:first").attr("selected","selected"):("undefined"!==typeof d&&"radio"===d?a.each(function(a){a=jQuery(this);"radio"===a.attr("type")&&(a.val()===c?a.prop("checked",!0):a.prop("checked",!1))}):a.val(c),b.addClass("tdc-css-inherited")),e.hide()):("undefined"!==typeof d&&"radio"===d?a.each(function(a){a=
jQuery(this);"radio"===a.attr("type")&&(a.val()===c?a.prop("checked",!0):a.prop("checked",!1))}):a.val(c),b.removeClass("tdc-css-inherited"),"all"===tdcSidebar.currentViewportSettings.name?e.hide():e.show())}else if(b.hasClass("tdc-property-range-responsive"))e="",_.isUndefined(a.data("placeholder"))||(e=a.data("placeholder")),d=a.next('input[type="text"]'),d.attr("placeholder",e),_.isUndefined(c)?(c=tdcSidebarPanel.getCurrentResponsiveValue(a.attr("name"),"all"),_.isUndefined(c)?(a.val(""),d.val("")):
(a.val(c),d.val(c),d.attr("placeholder",c),b.addClass("tdc-css-inherited"))):(a.val(c),d.val(c),b.removeClass("tdc-css-inherited"));else if(b.hasClass("tdc-property-range_multiple-responsive")){e=tdcIFrameData.getModel(a.data("model_id"));var f=a.data("param_name"),g=window.tdcAdminSettings.mappedShortcodes[e.attributes.tag];e=[];for(var l=d="",k=0;k<g.params.length;k++)if(f===g.params[k].param_name){f=g.params[k].tdc_values;for(var h in f)f.hasOwnProperty(h)&&(e.push(f[h].unit),""===d||""===l)&&
(d=f[h].value,l=f[h].unit);break}_.isUndefined(c)?(c=tdcSidebarPanel.getCurrentResponsiveValue(a.attr("name"),"all"),_.isUndefined(c)&&(a.data("range_value",d),a.data("range_unit",l),a.val(d),h=b.find('input[type="radio"][data-unit_value="'+l+'"]'),k=h.data("unit"),f=a.data("min_"+k),l=a.data("max_"+k),k=a.data("step_"+k),g=a.get(0),h.prop("checked",!0),g.min=f,g.max=l,g.step=k,g.value=d,h.data("last_value",d),b.find('input[type="text"]').val(d)),"all"===tdcSidebar.currentViewportSettings.name?b.removeClass("tdc-css-inherited"):
b.addClass("tdc-css-inherited")):b.removeClass("tdc-css-inherited");if(!_.isUndefined(c)){d=[];for(k=0;k<e.length&&!(d=c.split(e[k]),1<d.length);k++);d.length&&(d=d[0],l=e[k],a.data("range_value",d),a.data("range_unit",l),a.val(d),h=b.find('input[type="radio"][data-unit_value="'+l+'"]'),k=h.data("unit"),f=a.data("min_"+k),l=a.data("max_"+k),k=a.data("step_"+k),g=a.get(0),h.prop("checked",!0),g.min=f,g.max=l,g.step=k,g.value=d,h.data("last_value",d),b.find('input[type="text"]').val(d))}}},showShortcodeFromPath:function(a){if(!_.isUndefined(a)){a=
a.toString().split("_");var c;a.forEach(function(a,b){""!==a&&(_.isUndefined(c)?c=tdcIFrameData.tdcTopCollection.at(a):(b=c.get("childCollection"),!_.isUndefined(b)&&b.length>a&&(c=b.at(a))))});if(!_.isUndefined(c)){var b=c.get("blockUid");if(!_.isUndefined(b)){var e=tdcAdminIFrameUI.getLiveIframe();a=e.contents().find("#"+b);a.length||(a=e.contents().find('[data-td-block-uid="'+b+'"]'));a.length&&(e.contents().scrollTop(a.offset().top-100),b={},tdcOperationUI.inZone(a)?tdcOperationUI.inRow(a)?tdcOperationUI.inColumn(a)?
tdcOperationUI.inInnerRow(a)?tdcOperationUI.inInnerColumn(a)?(b.$currentZone=tdcOperationUI.inZone(a),b.$currentRow=tdcOperationUI.inRow(a),b.$currentColumn=tdcOperationUI.inColumn(a),b.$currentInnerRow=tdcOperationUI.inInnerRow(a),b.$currentInnerColumn=tdcOperationUI.inInnerColumn(a),b.$currentElement=a):(b.$currentZone=tdcOperationUI.inZone(a),b.$currentRow=tdcOperationUI.inRow(a),b.$currentColumn=tdcOperationUI.inColumn(a),b.$currentInnerRow=tdcOperationUI.inInnerRow(a),b.$currentInnerColumn=a):
(b.$currentZone=tdcOperationUI.inZone(a),b.$currentRow=tdcOperationUI.inRow(a),b.$currentColumn=tdcOperationUI.inColumn(a),b.$currentInnerRow=a):(b.$currentZone=tdcOperationUI.inZone(a),b.$currentRow=tdcOperationUI.inRow(a),b.$currentColumn=a):(b.$currentZone=tdcOperationUI.inZone(a),b.$currentRow=a):b.$currentZone=a,tdcSidebar._currentModel=c,a.data("model_id",c.cid),tdcSidebar.setSettings(b,!0,c))}}}}}})();var tdcUtil={};
...
tdcUtil._getStorage();if(null!==a)try{if(a=JSON.parse(tdcUtil.b64DecodeUnicode(a)),a.hasOwnProperty(k))return a[k]}catch(c){}},clearItem:function(){},_getStorage:function(){return window.localStorage.getItem(window.tdcAdminSettings.themeName)},_setStorage:function(k){window.localStorage.setItem(window.tdcAdminSettings.themeName,k)}}})();var tdcJobManager={};
