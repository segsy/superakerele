...
jQuery(document).ready( function() {
	(function($) {
		$("#speedycache_promo .speedycache_promo-close").click(function(){
			...
			$.get("'.admin_url('admin-ajax.php?action=speedycache_hide_promo').'&security='.wp_create_nonce('speedycache_nonce').'", data, function(response) {
				//alert(response);
			});
		});
	})(jQuery);
...
jQuery(document).ready( function() {
	(function($) {
		$("#speedycache_enable_nag .speedycache_nag-close").click(function(){
			...
			// Save this preference
			$.get("'.admin_url('admin-ajax.php?action=speedycache_hide_nag').'&security='.wp_create_nonce('speedycache_nonce').'", data, function(response) {
				//alert(response);
			});
		});
	})(jQuery);
