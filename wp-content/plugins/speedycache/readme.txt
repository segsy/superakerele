...
= 1.0.7 =
* [Feature] Added Test Mode, for user to test the options before pusing it to the live site.
...
* [Feature][Pro] Bloat Remover, we have added more than 10 options to remove bloat and speedup your WordPress site.
